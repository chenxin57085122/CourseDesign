        ...
        <div v-if="loginPage" class="content">
          <ul class="common-form">
            ...
            <li style="text-align: right" class="pr">
              ...
              <a href="javascript:;" class="register" @click="toRegister">点我注册账号</a>
              <a
  ...
  methods: {
    ...
    login () {
      ...
      userLogin(params).then(res => {
        if (res.code === 1) {
          this.messageSuccess()
          setStore('userId', res.content.id)
          setStore('account', res.content.account)
...
.v2 .dialog {
  ...
  .title {
    ...
    position: relative;
    background-image: url(/static/images/log1.png);
