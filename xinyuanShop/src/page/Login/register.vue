      ...
      <div class="dialog dialog-shadow" style="display: block; margin-top: -362px;">
        <div class="registered">
          ...
          <div class="content" style="margin-top: 20px;">
            <el-input v-model="registered.account" placeholder="请输入您的账号" class="input"></el-input>
            <el-input
              type="password"
            ...
            <el-input
              ...
              class="input"
            ></el-input>
            <el-input v-model="registered.phone" placeholder="手机" class="input"></el-input>
            <el-select v-model="registered.question" placeholder="请选择密码提示问题" class="input">
              <el-option
            ...
            <el-input v-model="registered.answer" placeholder="密码问题答案" class="input"></el-input>
            <li>
              <div id="captcha">
                <p id="wait"></p>
              </div>
            ...
            <div style="margin-bottom: 30px;">
              <y-button
                :classStyle="registered.password&&registered.userPwd2&&registered.account&&registered.phone&&registered.question&&registered.answer&&registxt==='注册'?'main-btn':'disabled-btn'"
                :text="registxt"
...
export default {
  ...
  methods: {
    ...
    regist () {
      this.registxt = '注册中...'
      let account = this.registered.account
      ...
      register({
        ...
        question: this.registered.question,
        answer: this.registered.answer
      }).then(res => {
